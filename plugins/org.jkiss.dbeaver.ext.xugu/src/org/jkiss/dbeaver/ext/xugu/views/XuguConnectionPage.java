...
import org.jkiss.dbeaver.ext.xugu.model.dict.XuguConnectionRole;
...
public class XuguConnectionPage extends ConnectionPageAbstract implements ICompositeDialogPage
{
    ...
    public void createControl(Composite composite)
    {
        ...
        final Group protocolGroup = UIUtils.createControlGroup(addrGroup, XuguMessages.dialog_connection_connection_type_group, 1, GridData.FILL_HORIZONTAL, 0);
        ...
        connectionTypeFolder.addSelectionListener(new SelectionAdapter()
        {
            ...
            {
                connectionType = (XuguConstants.ConnectionType) connectionTypeFolder.getSelection()[0].getData();
                site.getActiveDataSource().getConnectionConfiguration().setProviderProperty(XuguConstants.PROP_CONNECTION_TYPE, connectionType.name());
                updateUI();
            }
        });

        final Group securityGroup = UIUtils.createControlGroup(addrGroup, XuguMessages.dialog_connection_security_group, 4, GridData.FILL_HORIZONTAL, 0);
    ...
    private void createBasicConnectionControls(TabFolder protocolFolder)
    {
        ...
        protocolTabBasic.setText(XuguMessages.dialog_connection_basic_tab);
        protocolTabBasic.setData(XuguConstants.ConnectionType.BASIC);
        ...
        Label hostLabel = UIUtils.createControlLabel(targetContainer, XuguMessages.dialog_connection_host);
        ...
        UIUtils.createControlLabel(targetContainer, XuguMessages.dialog_connection_port);
        ...
        UIUtils.createControlLabel(targetContainer, XuguMessages.dialog_connection_database);
        ...
        sidServiceCombo.add(XuguConnectionType.SID.getTitle());
        sidServiceCombo.add(XuguConnectionType.SERVICE.getTitle());
    ...
    private void createTNSConnectionControls(TabFolder protocolFolder)
    {
        ...
        protocolTabTNS.setText(XuguMessages.dialog_connection_tns_tab);
        protocolTabTNS.setData(XuguConstants.ConnectionType.TNS);
    ...
    private Collection<String> getAvailableServiceNames()
    {
        ...
        if (CommonUtils.isEmpty(oraHome)) {
            ...
            XuguHomeDescriptor home = OCIUtils.getOraHomeByName(oraHome);
            if (home != null) {
    ...
    private void createCustomConnectionControls(TabFolder protocolFolder)
    {
        ...
        protocolTabCustom.setText(XuguMessages.dialog_connection_custom_tab);
        protocolTabCustom.setData(XuguConstants.ConnectionType.CUSTOM);
    ...
    {
        Label userNameLabel = UIUtils.createControlLabel(parent, XuguMessages.dialog_connection_user_name);
        ...
        Label userRoleLabel = UIUtils.createControlLabel(parent, XuguMessages.dialog_connection_role);
        ...
        userRoleCombo.add(XuguConnectionRole.NORMAL.getTitle());
        userRoleCombo.add(XuguConnectionRole.SYSDBA.getTitle());
        userRoleCombo.add(XuguConnectionRole.SYSOPER.getTitle());
        userRoleCombo.select(0);

        Label passwordLabel = UIUtils.createControlLabel(parent, XuguMessages.dialog_connection_password);
        ...
        osAuthCheck = UIUtils.createCheckbox(parent, XuguMessages.dialog_connection_os_authentication, false);
    ...
    {
        oraHomeSelector = new ClientHomesSelector(bottomControls, SWT.NONE, XuguMessages.dialog_connection_ora_home) {
            @Override
...
//        }
    ...
    {
        return this.connectionType == XuguConstants.ConnectionType.CUSTOM;
    }
    ...
    public void loadSettings()
    {
        ...
        final String sidService = connectionInfo.getProviderProperty(XuguConstants.PROP_SID_SERVICE);
        if (sidService != null) {
            sidServiceCombo.setText(XuguConnectionType.valueOf(sidService).getTitle());
        }
        ...
        switch (connectionType) {
            ...
            case TNS: {
                ...
                String tnsPathProperty = connectionInfo.getProviderProperty(XuguConstants.PROP_TNS_PATH);
...
//                }
        ...
        final String roleName = connectionInfo.getProviderProperty(XuguConstants.PROP_INTERNAL_LOGON);
        if (roleName != null) {
    ...
    public void saveSettings(DBPDataSourceContainer dataSource)
    {
        ...
        connectionInfo.setProviderProperty(XuguConstants.PROP_CONNECTION_TYPE, connectionType.name());
        switch (connectionType) {
            case BASIC:
            ...
            case TNS:
                ...
                connectionInfo.setProviderProperty(XuguConstants.PROP_TNS_PATH, tnsPathText.getText());
                break;
            case CUSTOM:
        ...
        if (osAuthCheck.getSelection()) {
            ...
            connectionInfo.setProviderProperty(XuguConstants.OS_AUTH_PROP, String.valueOf(true));
        } else {
            connectionInfo.setUserName(userNameText.getText());
            connectionInfo.setUserPassword(passwordText.getText());
            connectionInfo.removeProviderProperty(XuguConstants.OS_AUTH_PROP);
        }

        connectionInfo.setProviderProperty(XuguConstants.PROP_SID_SERVICE, XuguConnectionType.getTypeForTitle(sidServiceCombo.getText()).name());

        if (userRoleCombo.getSelectionIndex() > 0) {
            connectionInfo.setProviderProperty(XuguConstants.PROP_INTERNAL_LOGON, userRoleCombo.getText().toLowerCase(Locale.ENGLISH));
        } else {
            connectionInfo.getProviderProperties().remove(XuguConstants.PROP_INTERNAL_LOGON);
        }
